...
class TestPaymentPositive:
    ...
    def test_create_payment_success(
        ...
        response_data = CreateOrderPaymentResponseSchema.model_validate_json(
            response.text
        )
        assert_create_payment_response(
    ...
    def test_get_payment_info_success(
        self, private_payments_client: PaymentsAPIClient, create_payment: PaymentFixture
    ) -> None:
    ...
    def test_fake_succeed_payment_success(
        ...
        response_data = FakeSucceedPaymentResponseSchema.model_validate_json(
            response.text
        )
        assert_succeed_payment_response(
            actual=response_data, expected=create_payment.response
    ...
    def test_fake_cancel_payment_success(
        ...
        response_data = FakeCancelPaymentResponseSchema.model_validate_json(
            response.text
        )
        assert_cancel_payment_response(
            actual=response_data, expected=create_payment.response
