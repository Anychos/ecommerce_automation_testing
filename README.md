...
Проект объединяет API и UI тестирование в едином фреймворке и демонстрирует практические навыки, необходимые для позиции Junior AQA Engineer.
...
- **Allure отчёты** — после каждого прогона тестов генерируется отчет Allure
...
- Работу с REST API и UI на профессиональном уровне
...
- Доработать файл с переменными окружения Allure
- Написать allure steps для UI тестов
- Сделать рефакторинг структуры проекта
- Добавить CI/CD
- Добавить playwright tracing
