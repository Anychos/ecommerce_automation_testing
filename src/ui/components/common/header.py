...
class Header(BaseComponent):
    ...
    def __init__(self, page: Page):
        ...
        self.user_profile_dropdown_button = self.page.get_by_test_id(
    ...
    def dropdown_menu_link(self, link_name: str) -> Locator:
        return self.user_profile_dropdown_menu.get_by_test_id(
            f"dropdown-{link_name}-item"
        )

    @allure.step("Проверка видимости элементов хедера")
    def check_visibility(self, *, is_logged_in: bool = False) -> None:
        """
